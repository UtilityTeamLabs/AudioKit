...
open class AKBypassButton: UIView {
    ...
    func drawBypassButton(isBypassed: Bool = false) {
        ...
        let bypassLabelFontAttributes = [NSAttributedStringKey.font: UIFont.boldSystemFont(ofSize: 24),
                                         NSAttributedStringKey.foregroundColor: UIColor.black,
                                         NSAttributedStringKey.paragraphStyle: bypassLabelStyle]
        ...
        let processLabelFontAttributes = [NSAttributedStringKey.font: UIFont.boldSystemFont(ofSize: 24),
                                          NSAttributedStringKey.foregroundColor: UIColor.black,
                                          NSAttributedStringKey.paragraphStyle: processLabelStyle]
